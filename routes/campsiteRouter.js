...
//importing our Campsite MODEL in order to...CRUD
const Campsite = require("../models/campsite");

const authenticate = require("../authenticate");

//building out our method to access API endpoints
    ...
    Campsite.findById(req.params.campsiteId)
      .then((campsite) => {
        if (campsite && campsite.comments.id[req.params.commentId]) {
          ...
          if (req.user.id) {
            campsite.comments.id(req.params.commentId).author._id = req.user.id;
